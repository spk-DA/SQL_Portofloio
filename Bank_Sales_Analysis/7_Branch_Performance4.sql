...
62. Find the lowest-performing branch.
SELECT branch_name,
SUM(transaction_amount) AS total_business
FROM bank_transactions
GROUP BY branch_name
ORDER BY total_business ASC
LIMIT 1;

63. Find the branch with maximum deposits.
SELECT branch_name,
...
64. Find the branch with maximum withdrawals.
SELECT branch_name,
...
65. Find the average transaction by branch.
SELECT branch_name,
ROUND(AVG(transaction_amount), 2) AS average_transaction
FROM bank_transactions
GROUP BY branch_name;

66. Find the total customers by branch.
SELECT branch_name,
COUNT(DISTINCT customer_id) AS total_customers
FROM bank_transactions
GROUP BY branch_name;

67. Find the branch-wise average balance.
SELECT branch_name,
ROUND(AVG(balance_after_transaction), 2) AS average_balance
FROM bank_transactions
GROUP BY branch_name;

68. Find the branch-wise average credit score.
SELECT branch_name,
ROUND(AVG(credit_score), 2) AS average_credit_score
FROM bank_transactions
GROUP BY branch_name;

69. Find the branch-wise premium customers.
SELECT branch_name,
customer_segment,
...
70. Find the branch-wise business growth.
SELECT branch_name,
SUM(transaction_amount) AS total_business
FROM bank_transactions
GROUP BY branch_name
...
71. Find the branch-wise cash transactions.
SELECT branch_name,
...
72. Find the branch-wise digital transactions.
SELECT branch_name,
payment_channel,
...
73. Perform branch-wise customer segment analysis.
SELECT branch_name,
customer_segment,
SUM(transaction_amount) AS total_business
FROM bank_transactions
...
74. Find the branch-wise gender ratio.
SELECT branch_name,
gender,
COUNT(DISTINCT customer_id) AS total_customers
FROM bank_transactions
...
75. Perform branch-wise occupation analysis.
SELECT branch_name,
occupation,
SUM(transaction_amount) AS total_business
FROM bank_transactions
