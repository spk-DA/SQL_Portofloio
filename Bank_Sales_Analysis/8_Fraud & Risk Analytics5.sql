-- Module 5 – Fraud & Risk Analytics (76–90)
...
81. Find customers with credit score below 600.
SELECT customer_name,
...
82. Find transactions during weekends.
SELECT *
FROM bank_transactions
WHERE WEEKDAY(transaction_date) >= 5;

83. Find large withdrawals.
SELECT customer_name,
transaction_type,
transaction_amount
FROM bank_transactions
...
85. Find suspicious repeated transactions.
SELECT customer_name,
transaction_amount,
...
86. Find customers making many ATM withdrawals.
SELECT customer_name,
...
87. Find customers making many UPI payments.
SELECT customer_name,
...
88. Find branches with high-risk customers.
SELECT branch_name,
...
89. Find customers with loan default status.
SELECT customer_name,
credit_score
FROM bank_transactions
WHERE credit_score <= 600;

90. Generate a high-risk customer report.
SELECT customer_name,
age,
credit_score,
...
FROM bank_transactions
WHERE credit_score < 600
OR balance_after_transaction < 10000
